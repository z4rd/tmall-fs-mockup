...
export const ENTRYPOINTS: Entrypoint[] = [
  ...
  },
  {
    ...
    path: '/home/women',
    cardSrc: './images/entry/women.png',
    designed: true,
    status: 'live',
    statusLabel: '女子首页',
  },
  {
    ...
    cardSrc: './images/entry/commercial.png',
    designed: true,
    status: 'live',
    statusLabel: '双 11 会场',
  },
  {
    ...
    tagline: '独有一套',
    path: '/store/jordan',
    cardSrc: './images/entry/jordan.png',
    designed: true,
    status: 'live',
